...
public class AllExample extends JFrame {
    ...
    public AllExample() {
        ...
        for (String[] s : EXAMPLES) {
            model.addElement(s[1]);
        }
        exampleList = new JList(model);
        
        JScrollPane sp = new JScrollPane();
        sp.getViewport().setView(exampleList);
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                int idx = exampleList.getSelectedIndex();
                AppletRunner.run(EXAMPLES[idx][0], EXAMPLES[idx][1]);
